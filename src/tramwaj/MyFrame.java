...
public class MyFrame extends JFrame implements JMapViewerEventListener {
...
MapMarkerDot darmstadt = new MapMarkerDot(germanyEastLayer, "Darmstadt", 50.2,20.0048731);
