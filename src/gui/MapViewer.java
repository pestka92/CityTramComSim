...
public class MapViewer extends JFrame implements JMapViewerEventListener {
	...
	public MapViewer() {
        ...
        JLabel helpLabel = new JLabel("U�yj prawego przycisku myszki by si� porusza�,\n "
                + "podw�jnego klikni�cia lewym przyciskiem lub k�ka by przybli�y�/oddali�.");
        helpPanel.add(helpLabel);
        JButton button = new JButton("dopasuj podgl�d do znacznik�w");
        ...
        ///
        final JCheckBox showToolTip = new JCheckBox("Wsp�rz�dne");
